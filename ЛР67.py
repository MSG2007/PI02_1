...
def bubble_sort(arr):
    ...
    Принцип: последовательно перебираем элементы списка,
    меняя соседние элементы местами, если предыдущий больше следующего.
    Процесс повторяется, пока список не станет полностью отсортированным.
    """
...
def insertion_sort(arr):
    ...
    Принцип: последовательно берём каждый элемент массива и вставляем его на правильную позицию среди ранее отсортированных элементов.
    Время выполнения: O(n^2) в худшем и среднем случаях, O(n) в лучшем случае (если массив уже отсортирован).
    """
...
def shell_sort(arr):
    """
    Реализация алгоритма Shell Sort (Сортировка Шелла).
    Цель: Улучшить обычную сортировку вставками путём первоначального рассредоточенного сравнения элементов.
    Ключевая идея: Изначально сравниваются элементы, находящиеся далеко друг от друга, уменьшая расстояние между ними с каждой итерацией.
    """
...
def quick_sort(arr):
    ...
    Принцип: выбирается опорный элемент, затем массив делится на две части -
    элементы меньше опорного и элементы больше опорного. Рекурсивно сортируются обе части.
    """
    if len(arr) <= 1:
...
def linear_search(arr, target):
    ...
    Возвращает индекс искомого элемента, если он найден, иначе -1.
    """
...
def fibonacci_search(arr, target):
    """
    Реализация алгоритма поиска по Фибоначчи.
    Метод основан на разделении массива на части согласно числам Фибоначчи.
    Возвращает индекс искомого элемента, если он найден, иначе -1.
    """
