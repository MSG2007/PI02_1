...
Получение временной сложности: Мы экспоненциально увеличиваем индекс (удваивая его на каждом шаге), пока не достигнем элемента, который больше или равен искомому. Это займет примерно log n шагов, так как на каждом шаге мы удваиваем индекс.
