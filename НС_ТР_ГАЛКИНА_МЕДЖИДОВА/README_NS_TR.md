...
##### Описание DataSet
Для обучения и тестирования разработанной полносвязной нейронной сети был использован специальный DataSet для задачи классификации электронных писем по категориям "Спам"/"Не спам".
